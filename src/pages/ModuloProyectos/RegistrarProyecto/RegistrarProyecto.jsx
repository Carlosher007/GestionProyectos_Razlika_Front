...
import 'pages/ModuloProyectos/RegistrarProyecto/registrarP.css';
      ...
      <div className="datosProyecto" align="center">
        ...
        <div className="boton" align="center">
          <button type="button" style={{ color:"whitesmoke",fontSize: "larger",backgroundColor:"grey", borderRadius:"5px", padding:"10px"}}
            ...
            {show ? (
            <div style={{ color: 'red',fontSize: "larger" }}>Guarda tu proyecto!</div>
              ) : (
                <div style={{ color: 'green',fontSize: "larger" }}>Proyecto guardado!</div>
              )}
              </div>
