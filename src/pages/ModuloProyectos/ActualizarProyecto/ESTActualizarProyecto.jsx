...
import 'pages/ModuloProyectos/ActualizarProyecto/actualizarP.css';
  ...
  return (
    <>
      ...
      <div className="datosProyecto" align="center">
          ...
          <div className="datos">
            <ul className="input"><input type="text" /></ul>
            <ul className="input"><input type="text" /></ul>
            <ul className="input"><input type="text" /></ul>
            <ul className="input"><input type="text" /></ul>
            <ul className="input"><input type="text" /></ul>
        ...
        <div className="datosProyecto1" align="center">
          ...
          <div className="datos">
            <ul className="input"><input type="date" /></ul>
            <ul className="input"><input type="date" /></ul>
            <ul className="input"><input type="text" /></ul>
            <ul className="input"><input type="text" /></ul>
            <ul className="input"><input type="text" /></ul>
        ...
        <div className="boton" align="center">
          <button type="button" style={{ color:"whitesmoke",fontSize: "larger",backgroundColor:"grey", borderRadius:"5px", padding:"10px"}}
            ...
            {show ? (
            <div style={{ color: 'red',fontSize: "larger" }}></div>
              ) : (
                <div style={{ color: 'red',fontSize: "larger" }}>Actualizando Proyecto!</div>
              )}
              </div>
...
export default ESTActualizarProyecto
